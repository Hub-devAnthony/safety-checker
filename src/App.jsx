...
function App () {
  ...
  return (
      ...
      <AnimatePresence>
        {Open && (
          <motion.div
            ...
            className="fixed inset-0 bg-white flex flex-col items-center justify-evenly space-y-8 text-xl font-medium z-40"
          >
            ...
            <button className='w-[50vw] h-16 bg-green-600 hover:bg-green-700 text-white rounded-2xl text-sm font-semibold'>Get Started</button>
          </motion.div>
        )}
      </AnimatePresence>
    </header>
    ...
    <p className='mt-20 ml-3 mr-5 font-semibold text-lg text-gray-600'>Your trusted eco-friendly household chemical checker. Balancing science, safety and sustainability for healthier families and a greener planet.</p>
      ...
      <button className='block mt-8 mx-auto w-[50vw] h-16 bg-green-600 hover:bg-green-700 text-white rounded-3xl font-semibold text-sm'>Get Started</button>
